...
from config import (
    STORE_API_BASE_URL, REDIS_HOST, REDIS_PORT,
...
async def save_processed_agent_data(processed_agent_data: ProcessedAgentData):
    try:
        ...
        if redis_client.llen("processed_agent_data") >= BATCH_SIZE:
            processed_agent_data_batch = [json.loads(redis_client.lpop("processed_agent_data")) for _ in
                                          range(redis_client.llen("processed_agent_data"))]
            print(len(processed_agent_data_batch))
